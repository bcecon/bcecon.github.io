...
|------------|--------------|----------------|
| **Farming Income** | Subsistence income from your land plot | \$70 |
| **PES Payment** | Payment for entering PES contract | \$50 |
| **Forest Harvesting** | \$10 × card number (if not in PES) | varies |
| **Policing / Fines** | Cost of enforcement or penalties | varies |
...
- PES contracts available at **\$50** payment.  
- If you take PES, **you cannot harvest**.  
- All contracts are audited (no illegal harvest possible).
...
- Each community jointly decides:  
  - Whether to enter PES at \$50 per household.  
  - How to divide PES payments.  
