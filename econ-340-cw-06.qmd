...
Typically, this amounts to about **\$8–\$12 per winner**.
...
```{=html}
<iframe id="contentFrame" width="100%" height="1100px" frameborder="no" 
...
- Each community jointly decides:  
  ...
  - If the community joins, it receives a total PES payment equal to  
    $$
...
```{=html}
<iframe id="contentFrame" width="100%" height="1450px" frameborder="no" 
...
- Community Decisions:  
  ...
  2. If yes → **Police the group?** (cost = \$5 per household)  
    - If policing → no household does harvest illegally.
...
```{=html}
<iframe id="contentFrame" width="100%" height="1700px" frameborder="no" 
...
| 2  | Illegal Harvest       | PES / No       | Y / N            | Y / N    | \$70       | \$     | \$         | \$       |                                |
| 3  | Community             | PES / No       |                  |          | \$70       | \$     | \$         | \$       |                                |
| 4  | Comm + Ill. Harvest   | PES / No       | Y / N            | Y / N    | \$70       | \$     | \$         | \$       |                                |
| **TOTAL** |                |                |                  |          |            |        |            |          | \$                             |
