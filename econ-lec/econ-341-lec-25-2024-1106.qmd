...
- **Compliance Markets**:
  ...
  - **Carbon Tax Programs**: In some cases, offsets canreduce the level of taxable emissions by subtracting certified reductions from actual emissions.
...
- **Discretionary Adjustments**:
  ...
  - *Example*: A five-year review process.
