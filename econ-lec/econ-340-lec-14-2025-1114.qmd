...
- **What the strategies mean under CBAM:**  
  ...
  - **Defect** → keep weak policy (under-price carbon)  
- The strategic advantage of under-pricing disappears:
...
- **What the strategies mean under Climate Clubs:**  
  - **Cooperate** → join the club (adopt high-ambition climate policy)  
  - **Defect** → stay out (keep weaker policy)  
