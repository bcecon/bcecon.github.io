...
- Current trade rules often **favor high-carbon production**, because:
  - Carbon tariffs are difficult under WTO rules.  
...
<div style="display:block; margin:-50px;"></div>
<span class="fragment">👉 CBAMs **internalize the competitiveness problem**, eliminating the gain from under-pricing and making **Cooperate → the dominant strategy**.</span>
