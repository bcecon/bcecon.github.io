...
- This rate reflects how we **value the future relative to the present**, and it can be determined in two main ways:
  ...
  - Through **observed market behavior** and the **opportunity cost of capital** → the **market-based (descriptive)** approach
...
- $\eta$: **elasticity of marginal utility of consumption** — measures how quickly **the extra satisfaction (utility)** from consumption **declines as people become richer**  
  ...
  - **Inequality aversion:** a higher $\eta$ means society is more sensitive to inequality across generations
...
<!-- - **Wealth effect:** together, $\eta$ and $g$ determine how **fast overall welfare grows** as society becomes wealthier -->
...
- Sets parameters based on **ethical principles** of **intergenerational fairness**, not on market behavior  
  ...
  - $\eta$: reflects **inequality aversion** — society places **less value on extra income for richer future generations**  
...
- Sets parameters based on **observed economic behavior**, not ethical judgments  
  ...
  - $\eta$: inferred from **market data** — captures how people trade off **consumption and risk** over time  
...
::: callout-note
Although Nordhaus assumes a higher $\eta$ (greater inequality aversion),  
