...
$$
\text{SDR} = \color{#d55e00}{\rho} + \color{#0072b2}{\eta}\cdot \color{#009e73}{g}
$$
...
- $\color{#009e73}{g}$: <u>**growth rate of consumption**</u> — reflects how **average living standards** or **income per person** grow over time
...
- **Welfare growth effect:** $\color{#0072b2}{\eta}$ and $\color{#009e73}{g}$ together determine how the growth in income ($\color{#009e73}{g}$) translates into growth in **social welfare**.  
  - $\color{#009e73}{g}$ drives the rise in **consumption**
...
- To maximize **well-being across generations**, **dynamic efficiency** seeks a path that **balances** present and future welfare:
  - <u>How much of today’s output should we **consume now** versus **invest for the future** (e.g., in renewable energy or infrastructure)?</u>
    - The $\text{SDR} = \color{#d55e00}{\rho} + \color{#0072b2}{\eta}\cdot \color{#009e73}{g}$ provides the answer.
...
- Sets parameters based on **observed market behavior**, not ethical judgments  
  - $\color{#d55e00}{\rho}$: **higher** (≈ 1–2%) — reflects society’s **revealed time preference** in saving and investment decisions  
  - $\color{#0072b2}{\eta}$ (**Higher**, ≈ 1.5) — means society places **greater weight on poorer or earlier generations**
  - $\color{#009e73}{g}$: assumes **stronger long-run growth** (e.g., 2%), consistent with **historical productivity trends**  
...
- Parameters are chosen based on **ethical reasoning** about **intergenerational fairness**, rather than market behavior  
  ...
  - $\color{#009e73}{g}$: assumes **modest long-run growth** (≈ 1–1.5%), consistent with **sustainability goals**  
...
- **2018 Survey of Economists:**  
  - Mean = **2.3%**, Median = **2.0%** (**SDR** for intergenerational global projects)  
