...
:::{.nonincremental}
- **Definition**:
  - Catch equals the growth rate of the population.
...
- **Effect on Efficient Effort Level**:
  - Technological improvements lower marginal costs.
...
- **Sole Owner vs. Open Access**:
  ...
  - **Open Access**: Leads to overexploitation, effort level increases to where profits are zero ($E^{c}$).
...
## Raising the Real Cost of Fishing
 ...
 <div style="text-align: center; width: 100%; margin: auto;">
  <img src="https://bcdanl.github.io/lec_figs/tl-fig17-7.png" style="width: 50%; margin-bottom: -20px;">
  <p style="font-weight: bold;"></p>
</div>
...
::: {.column width="50%"}
- **Early Policies**:
  - Banning efficient gear (e.g., traps).
...
- **Inefficiency Resulted**:
  - Increased real resource costs.
  - Overcapitalization in fishing fleets.
  - Did not maximize net benefits.
