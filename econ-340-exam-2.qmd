...
Under the standard model of **time-consistent rational discounting**, individuals apply a constant discount rate over time, so their preferences between today and the future remain stable. **Bounded willpower**, however, is captured by **present-biased (time-inconsistent) discounting**, where people apply a much higher discount rate to the immediate future than to later periods. As a result, today’s self strongly favors immediate gratification, even when future benefits are large. This leads to preference reversals over time and self-control problems.
