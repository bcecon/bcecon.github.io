...
If $\tau$ is set equal to the external damage per unit of logging ($\delta$), then the private decision condition matches the social condition. Loggers internalize the climate cost and choose the socially efficient effort $L^*$.  

### d1 — Pigouvian Alignment
Assume $\delta=0.5$. Show that setting $\tau=\delta$ implements the socially efficient effort $L^*$.
