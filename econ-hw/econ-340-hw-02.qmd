...
1. **Private/market effort** $L^{priv}$
2. **Socially efficient effort** $L^{*}$
3. **Open-access effort** $L_{OA}$
...
Two representative households A and B value **grid reliability** $G$ (a public good).  
