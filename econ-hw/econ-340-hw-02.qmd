...
3. **Open-access level $L_{OA}$** — *Free entry drives profit per unit to zero.*  
   - *Definition:* With **many competing loggers**, entry continues until **average benefit equals average cost**. Each logger just breaks even, and resource rents are dissipated.  
