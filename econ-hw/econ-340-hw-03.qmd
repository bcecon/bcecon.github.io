...
$$
\text{PV}_B(4\%) = \frac{70}{1+0.04} + \frac{95}{(1+0.04)^2} + \frac{95}{(1+0.04)^3} + \frac{95}{(1+0.04)^4} + \frac{90}{(1+0.04)^5}
$$

$$
\text{PV}_B(4\%) \approx 394.78 \quad \Rightarrow \quad \text{Private PV}_{NB} = -500 + 394.78 = \mathbf{-105.22\text{ million}}
$$

**Interpretation:**  
At a 4% discount rate, the private $\text{PV}_{NB}$ is **negative**, meaning the company would **not invest** in CCUS without additional incentives.
