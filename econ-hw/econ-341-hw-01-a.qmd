...
- Note that the marginal utility of contribution under this program, $\frac{dU_i}{dg_i}$, can range from 0 to a positive value, depending on $m$. For a sufficiently large $m$, $\frac{dU_i}{dg_i} \geq 0$. There exists a minimum value, $m^{o}$, that incentivizes a villager $i$ to contribute their entire endowment $y$:
