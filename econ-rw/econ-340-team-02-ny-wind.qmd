...
- **Use evidence from the literature (no new data analysis needed)**  
  ...
  - **“Community Engagement and Equity in Renewable Energy Projects: A Literature Review”** (NREL)  
    <https://doi.org/10.2172/1996557>  
    – for concepts such as **procedural**, **distributional**, and **recognition** justice, and best practices in **community engagement** for renewable projects.  
  - **“The visual effect of wind turbines on property values is small and diminishing in space and time”** (PNAS)  
    <https://www.pnas.org/doi/10.1073/pnas.2309372121>  
    – as an example of how economists measure local costs using **property value** impacts, and what the evidence suggests about the magnitude of these costs.
