...
&= \frac{5000}{9} = \frac{2^{3}\times5^{4}}{3^{2}}
\end{align}
$$
...
$$
\begin{align}
DWL_{p} - DWL_{q} &= \frac{5^6}{2\times3^{2}} - \frac{2^{3}\times5^{4}}{3^{2}}\\
&= \frac{5^{4}}{3^{2}}\left(\frac{5^{2}}{2} - 2^{3} \right)\\
&= \frac{5^{4}}{3^{2}}\left(12.5 - 8 \right)\\
&> 0
\end{align}
$$
Therefore, the DWL is higher for the tax than cap-and-trade.
